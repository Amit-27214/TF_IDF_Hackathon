...
def load_vocab():
    ...
    with codecs.open('idf-values.txt', 'r', encoding='utf-8') as f:
...
def load_inverted_index():
    inverted_index = {}
    with codecs.open('inverted-index.txt', 'r', encoding='utf-8') as f:
...
def load_link_of_qs():
    with codecs.open("Qindex.txt", "r", encoding='utf-8') as f:
        links = f.readlines()
