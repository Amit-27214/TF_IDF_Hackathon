...
with open('vocab.txt', 'w',encoding = find_encoding(filename),errors ="ignore") as f:
...
with open('idf-values.txt', 'w',encoding = find_encoding(filename),errors ="ignore") as f:
    for key in vocab.keys():
        f.write("%s\n" % vocab[key])
...
with open('documents.txt', 'w',encoding = find_encoding(filename),errors ="ignore") as f:
...
with open('inverted-index.txt', 'w',encoding = find_encoding(filename),errors ="ignore") as f:
